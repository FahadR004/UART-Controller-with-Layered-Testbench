...
**4. Monitor**   
Monitor is responsible for reading the values driven by the monitor to the DUT and for reading the output values generated by the DUT. The monitor places these values in a transaction instance in a mailbox for the scoreboard to read.
